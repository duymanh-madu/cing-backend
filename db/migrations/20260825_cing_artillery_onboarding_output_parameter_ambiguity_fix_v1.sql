...
-- =====================================================
-- CING ARTILLERY — ONBOARDING OUTPUT-PARAMETER
-- AMBIGUITY FIX V1
--
-- Forward-only correction.
--
-- Root cause:
-- RETURNS TABLE exposes account_id as a PL/pgSQL
-- output variable while the function also uses bare
-- account_id column identifiers in SQL statements.
--
-- PostgreSQL default variable-conflict policy therefore
-- raises 42702 before onboarding can complete.
--
-- The compiler directive below explicitly preserves
-- SQL-column authority when names collide.
--
-- No schema, gameplay, economy, reward, beta membership,
-- root gameplay gate or worker state is changed.
-- =====================================================
